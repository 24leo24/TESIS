...
import io
from usuario.conexion_sqlite import Comunicacion  # Importa la clase Comunicacion desde el archivo conexion_sqlite.py
...
class Frame5(tk.Frame):
    ...
    def crear_archivos(self):
        datos_contenedores = self.comunicacion.mostrar_datos()  # Obtiene los datos desde la base de datos
        ...
        self.tabla = ttk.Treeview(self.marco_scroll, height=14,columns=("ID", "Nombre", "Asignatura", "Recomendación"), show="headings")
        ...
        self.boton_exportar.config(width=12, font=('Arial', 12, 'bold'),fg = '#DAD5D6', bg='#229805', cursor='hand2', activebackground='#34CD0E')
        ...
        self.boton_borrar.config(width=12, font=('Arial', 12, 'bold'), fg = '#DAD5D6', bg='#3371FF', cursor='hand2', activebackground='#33ACFF')
    ...
    def borrar_fila(self):
        ...
        if selected_item:
            ...
            #self.comunicacion.eliminar_datos(str(fila_id))
